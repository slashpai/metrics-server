...
const (
	rootPackage = "github.com/kubernetes-incubator/metrics-server"
)
...
func (i *ImportRestriction) isRestrictedPath(packageToCheck string) bool {
	...
	// github.com/kubernetes-incubator/metrics-server or github.com/kubernetes-incubator/metrics-server/vendor
